...
import { type CodeConnectBuildResult, createCompiler, type CreateCompilerOptions } from '../compile'
 ...
 */
export async function prepareCodeConnect(
  opts: PrepareCodeConnectOptions,
): Promise<CodeConnectPrepareResult> {
