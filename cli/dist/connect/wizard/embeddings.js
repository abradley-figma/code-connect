...
async function fetchEmbeddings({ uniqueMatchableNames, accessToken, figmaUrl, apiUrlOverride, }) {
    const apiUrl = (0, figma_rest_api_1.getApiUrl)(figmaUrl, apiUrlOverride);
