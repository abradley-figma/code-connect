...
export declare class FigmaCodeConnectPlugin implements WebpackPluginInstance {
    private opts;
    private codeConnectCompiler;
    constructor(opts?: CodeConnectWebpackOptions);
    apply(compiler: WebpackCompiler): void;
    private rebuildAndEmit;
}
export declare function figmaCodeConnect(opts?: CodeConnectWebpackOptions): FigmaCodeConnectPlugin;
export {};
